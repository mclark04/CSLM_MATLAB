function [CDM,CDH,RIB,CFLUX...QG,QA,ZOMIN,ZOHIN,
      ... CRIB,TVIRTG,TVIRTA,VA,FI,ITER,
      ] = ...ILG,IL1,IL2
    DRCOEF(CDM,CDH,RIB,CFLUX,ZOMIN,ZOHIN,...QG,QA,
      CRIB,TVIRTG,TVIRTA,VA,FI,ITER,...
      IL1,IL2,...ILG,
      GRAV,VKC)
% C
...
% 
%[ZOM,ZOH]=makeBlanks(1,length(IL1:IL2));
[ZOM,ZOH]=makeZeros(1,length(IL1:IL2));
    ...
    if(FI(I)>0. && ITER(I)==1)             
        ...
        if(RIB(I)<0.0) 
            ...
            PSIM1=log(((1.00+(1.00-15.0*OLS)^0.250)/2.00)^2*...
                (1.0+(1.00-15.0*OLS)^0.5)/2.0)-2.0*atan((1.00-15.0*OLS)^0.250)+atan(1.00)*2.00;
            PSIM0=log(((1.00+(1.00-15.0*OLS*ZOM(I))^0.250)/2.00)^2*...
                (1.0+(1.00-15.0*OLS*ZOM(I))^0.5)/2.0)-2.0*atan((1.00-15.0*OLS*ZOM(I))^0.250)+atan(1.00)*2.0;
            ...
            PSIH0=-(1.0+2.0*OLS*ZOH(I)/3.0)^1.5-0.667*(OLS*ZOH(I)-AA1)*exp(-0.35*OLS*ZOH(I))-AA+1.0;
